            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         tr("SabatiniCoin will close now to finish the encryption process. Remember that encrypting your wallet cannot fully protect your sabatinicoin from being stolen by malware infecting your computer."));
                    QApplication::quit();
                }
                else
                {
